...
_C.TRAIN.LR_DECAY_STEPS = [60, 80]
_C.TRAIN.LR_DECAY_GAMMA = 0.1
_C.TRAIN.GRAD_CLIP_VAL = 0.0
_C.TRAIN.SEQ_LEN = 16
...
_C.LOSS_WEIGHTS.KEYPOINTS_2D = 1.0
_C.LOSS_WEIGHTS.KEYPOINTS_3D = 1.0
_C.LOSS_WEIGHTS.GLOBAL_ORIENT = 1.0
_C.LOSS_WEIGHTS.HAND_POSE = 1.0
_C.LOSS_WEIGHTS.BETAS = 1.0

_C.DATASETS = CN(new_allowed=True)
_C.DATASETS.TRAIN = ""
_C.DATASETS.VAL = ""
_C.DATASETS.IMAGE_ROOT = ""
_C.DATASETS.SEQ_LEN = 16

_C.MODEL = CN(new_allowed=True)
_C.MODEL.IMAGE_SIZE = 224

_C.MANO = CN(new_allowed=True)
_C.MANO.DATA_DIR = os.path.join(CACHE_DIR_HAWOR, "data")
_C.MANO.MODEL_PATH = os.path.join(CACHE_DIR_HAWOR, "data/mano")
_C.MANO.MEAN_PARAMS = os.path.join(CACHE_DIR_HAWOR, "data/mano_mean_params.npz")
_C.MANO.GENDER = "neutral"
_C.MANO.NUM_HAND_JOINTS = 15
_C.MANO.CREATE_BODY_POSE = False
_C.MANO.IS_RHAND = True
_C.MANO.FLAT_HAND_MEAN = False
_C.MANO.USE_PCA = False
_C.MANO.JOINT_REGRESSOR_EXTRA = ""
